...
This is so automatic in fact, everything in EmbraceSQL is a batch -- it's just that when you send in named parameters *not* in an array, it is a 'batch of one'.
